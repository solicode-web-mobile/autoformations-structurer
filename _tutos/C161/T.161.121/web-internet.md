...
**Prérequis** : Un ordinateur, un navigateur et une connexion Internet.
...
Vous identifiez plusieurs pages appartenant au même site Web.

## 2.3. Découvrir une application Web

### Étape 5 — Observer une application Web

Ouvrez une application Web.
...
Vous pouvez expliquer simplement la différence entre un site Web et une application Web.

## 2.4. Créer la présentation

### Étape 7 — Créer une présentation
...
Les autres apprenants peuvent consulter votre présentation et vous pouvez expliquer les notions principales avec vos propres mots.
