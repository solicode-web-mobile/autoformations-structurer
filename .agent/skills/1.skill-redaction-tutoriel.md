ne pas utiliser : ```text id="c8c4pw", utiliser directement ```text sans id=...



Pour les prochains tutoriels Spartel, les blocs de code seront toujours écrits sous la forme standard :
...
Cette règle s’applique à tous les langages utilisés : `text`, `javascript`, `bash`, etc.
