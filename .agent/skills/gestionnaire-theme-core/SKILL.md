...
3. **Synchronisation** : Rappeler systématiquement à l'utilisateur qu'il doit exécuter `.\push_theme.ps1` (ou l'exécuter à sa place s'il le demande) pour que les nouveaux fichiers soient diffusés au Core Theme.
